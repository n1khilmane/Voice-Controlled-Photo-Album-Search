...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            ...
            sessionToken: '',
            region: 'us-east-1',
            apiKey: 'hHrLdYpAwDzt03yDa5Io1rVfO56I5Rj8ps7WAbQ1',
    ...
    var invokeUrl = 'https://xa25mgsax8.execute-api.us-east-1.amazonaws.com/dev';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['key', 'bucket', 'Accept', 'Content-Type', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'x-amz-meta-customLabels', 'Access-Control-Allow-Methods'], ['body']);
        ...
        var uploadBucketKeyPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Accept', 'Content-Type', 'Access-Control-Allow-Origin', 'Access-Control-Allow-Headers', 'x-amz-meta-customLabels', 'Access-Control-Allow-Methods']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
